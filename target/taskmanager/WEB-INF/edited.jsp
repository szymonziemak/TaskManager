...
<div class="row justify-content-center">
    <div class="col-md-5">
        <form action="edited" method="post">
            ...
            <br><br><h3>Edytuj istniejące zadanie</h3><br>
            <input type="hidden" name="task_id"  value="${requestScope.taskToEdit.task_id}">

            <div class="form-group">
                <label>Nazwa</label>
                <textarea name="inputName" class="form-control" rows="1" required autofocus><c:out value="${requestScope.taskToEdit.name}"></c:out></textarea>
                <small class="form-text text-muted">Nazwa zadania może się składać z maksymalnie 60 znaków.</small>
            </div>
            <div class="form-group">
                <label>Opis</label>
                <textarea name="inputDescription" class="form-control" rows="4" required><c:out value="${requestScope.taskToEdit.description}"></c:out></textarea>
